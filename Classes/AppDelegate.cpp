...
bool AppDelegate::applicationDidFinishLaunching() {
    ...
    if(!glview) {
        ...
        glview = GLViewImpl::createWithRect("BlindSlayer", cocos2d::Rect(0, 0, 320, 480));
#else
        glview = GLViewImpl::create("BlindSlayer");
#endif
        director->setOpenGLView(glview);
    }

	//해상도 변경
	director->getOpenGLView()->setFrameSize(1024, 768);
	...
	//auto scene = StageSeven::createScene();
